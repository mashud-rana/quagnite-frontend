...
} from "@/redux/features/student/profileInto/profileApi";
...
const Account = () => {
  ...
  useEffect(() => {
    if (
      isUpdatePasswordDataSuccess &&
      updatePasswordData &&
      updatePasswordData.success
    ) {
      // Handle successful update
      toastSuccess(
        updatePasswordData?.message || "Profile password updated successfully"
      );
    }
    if (isUpdatePasswordDataError) {
      toastError(
        updatePasswordDataResponseError?.data?.message ||
    ...
    isUpdatePasswordDataSuccess,
    updatePasswordData,
    isUpdatePasswordDataError,
    updatePasswordDataResponseError,
  ]);
