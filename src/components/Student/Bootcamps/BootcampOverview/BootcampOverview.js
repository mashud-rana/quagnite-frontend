...
export function BootcampOverview({ courseDetails }) {
  ...
  return (
    <div className={styles.overviewContainer}>
      ...
      <div className={styles.header}>
        <h2 className={styles.title}>About this Bootcamp</h2>
          ...
          <div className={styles.ic_list_container}>
            <div className={styles.statsList}>
              <div className={styles.statRow}>
                ...
                <span className={styles.statValue}>{bootcamp?.difficulty?.title}</span>
              </div>
              <div className={styles.statRow}>
                <span className={styles.statLabel}>Students:</span>
                <span className={styles.statValue}>{bootcamp?.total_enrolled_students}</span>
              </div>
              <div className={styles.statRow}>
                <span className={styles.statLabel}>Lectures:</span>
                <span className={styles.statValue}>{bootcamp?.lectures_count}</span>
              </div>
              <div className={styles.statRow}>
                <span className={styles.statLabel}>Video:</span>
                <span className={styles.statValue}>{bootcamp?.lectures_video_duration}</span>
              </div>
            </div>
            ...
            <div className={styles.statsList}>
              <div className={styles.statRow}>
                ...
                <span className={styles.statValue}>{bootcamp?.language?.title}</span>
              </div>
              <div className={styles.statRow}>
        ...
        <div className={styles.rightColumn}>
          ...
          <div className={styles.learningList}>
            ...
            <div className={styles.learningItem}>
                <FaCircle className={styles.bulletPoint} />
                <span className={styles.learningText}>{bootcamp?.difficulty?.title}</span>
              </div>
          </div>
        </div>
      </div>
