...
import styles from "./tutionEducation.module.css";
import img from "@/assets/images/all/tution-education.png";
import bg from "@/assets/images/all/tution-education-bg.png";
import Image from "next/image";
import CardAnimation from "@/components/Share/ClientComponent/CardAnimation";

const TutionEducation = () => {
  return (
    <section
...
export default TutionEducation;
