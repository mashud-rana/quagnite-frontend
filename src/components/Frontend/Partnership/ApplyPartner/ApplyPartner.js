...
import styles from "./applyPartner.module.css";
...
export default function ApplyPartner() {
  ...
  return (
    <section className={`${styles.ic_apply_partnership} ic_section_space`}>
      <div className="container">
        <div className={styles.ic_apply_partnership_main}>
          <CardAnimation index={0} direction="up">
            <h6 className="mb_16">Apply to be a partner</h6>
            <h4 className="mb-35">Make Your Move</h4>
