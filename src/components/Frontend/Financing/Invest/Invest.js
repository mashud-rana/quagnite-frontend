          ...
          <div className={styles.textContainer}>
            <div>
              ...
              <p>
                ...
                there. With a variety of options on interest rate and percentage
                of tuition, you can make the plan that fits your situation, and
                more importantly, gets you where you want to be.
              </p>
            </div>
