...
import styles from "./tuitionDetails.module.css";
          ...
          <Col xs={24} md={14} lg={12}>
            <div className={styles.ic_right}>
              <CardAnimation index={0} direction="right">
                <h6 className="mb-35">TUITION DETAILS</h6>
                <h4 className="mb-24">Tuition Name</h4>
                <p className={`${styles.ic_designation} mb-24`}>Coach Name</p>
                <p className="mb-24">
                ...
                <div className={`${styles.ic_data_wrapper} mb-45`}>
