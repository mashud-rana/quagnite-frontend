            ...
            <CardAnimation index={0} direction="left">
              <div className={styles.ic_banner_left}>
                ...
                <p>
                  ...
                  {`industry's`} future than by sponsoring a scholarship. Not
                  only do sponsors gain demonstrated social capital, but by
                  building a loyal cadre of scholars who are dedicated to making
                  the world better than it was, scholarships help create a
                  perpetuating engine of advancement. Sponsor a scholarship and
