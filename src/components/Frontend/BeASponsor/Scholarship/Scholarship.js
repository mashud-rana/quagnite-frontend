...
export default function Scholarship() {
    ...
    <section className={`${styles.ic_scholarship} ic_section_space`}>
      <div className="container">
                ...
                <ScholarshipInfo currentStep={1} setScholarshipActiveStep={setScholarshipActiveStep} />
                )}
                {scholarshipActiveStep === 2 && (
                <ScholarshipInfo currentStep={2} setScholarshipActiveStep={setScholarshipActiveStep} />
                )}
                {scholarshipActiveStep === 3 && (
                <ScholarshipInfo currentStep={3} setScholarshipActiveStep={setScholarshipActiveStep} />
                )}
                {scholarshipActiveStep === 4 && (
                <ScholarshipInfo currentStep={4} />
)}
        </div>
      </div>
    </section>
