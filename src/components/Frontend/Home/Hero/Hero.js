            ...
            <div className={styles.leftContent}>
              ...
              <CardAnimation index={0} direction="up">
                <p className={styles.heroDescription}>
                  ...
                  From self-paced learning to expert instruction, a broad range
                  of subjects gives you the skills you need to succeed at the
                  leading edge of technology and industry.
                </p>
